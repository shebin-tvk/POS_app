...
const Bill = () => {
  ...
  return (
    ...
    <div className='flex item-center justify-between px-5 mt-2'>
        ...
        <h1 className='text-[#f5f5f5] text-md fond-bold '>₹{total.toFixed(2)}</h1>
    </div>

    <div className='flex item-center justify-between px-5 mt-2'>
        <p className='text-xs text-[#ababab] font-medium mt-2'>Tax(5%)</p>
        <h1 className='text-[#f5f5f5] text-md fond-bold '>₹{tax.toFixed(2)}</h1>
    </div>

    <div className='flex item-center justify-between px-5 mt-2'>
        <p className='text-xs text-[#ababab] font-medium mt-2'>Total With Tax</p>
        <h1 className='text-[#f5f5f5] text-md fond-bold '>₹{totalPriceWithTax.toFixed(2)}</h1>
    </div>
