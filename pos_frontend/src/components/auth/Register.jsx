    ...
    <div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <div className="flex item-center rounded-lg p-5 px-4 bg-[#1f1f1f]">
                    <input type="email" name='email' value={formData.email} onChange={handleChange} placeholder='Enter employee email' className='bg-transparent flex-1 text-white focus:outline-none' required />
                </div>
            ...
            <div>
                ...
                <div className="flex item-center rounded-lg p-5 px-4 bg-[#1f1f1f]">
                    <input type="phone" name='phone' value={formData.phone} onChange={handleChange} placeholder='Enter employee phone' className='bg-transparent flex-1 text-white focus:outline-none' required />
                </div>
            ...
            <div>
                ...
                <label className='block text-[#ababab] mb-2 mt-3 text-sm font-medium'>Passwords</label>
                <div className="flex item-center rounded-lg p-5 px-4 bg-[#1f1f1f]">
                 ...
                 <div className='flex item-center gap-3 mt-4'>
                     ...
                     {["Waiter", "Cashier", "Admin"].map((role) => {
                        return(
                          ...
                          className={` px-4 py-3 w-full rounded-lg text-[#ababab] ${formData.role === role ? "bg-indigo-700" : "bg-[#1f1f1f]"}`}>
                            {role}
                          </button>                        
                              )
                     })}
