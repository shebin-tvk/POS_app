...
const Modal = ({title, onClose, isOpen, children}) => {
  ...
  return (
    <div className='fixed inset-0 bg-black/50 flex item-center justify-center z-50'>
        ...
        <div className='bg-[#1a1a1a] shadow-lg w-full max-w-lg mx-4 my-30  rounded-lg p-4'>

            <div className='flex justify-between item-center px-6 py-4 border-b border-[#333]'>
